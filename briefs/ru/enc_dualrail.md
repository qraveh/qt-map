...
Dual-rail — природный кубит фотоники: Chuang и Yamamoto (1995) назвали его «простой формой коррекции ошибок» [S][314]; Knill, Laflamme и Milburn построили на нём линейную оптику в 2000 г. [S][267]. Перенос на сверхпроводники был осознанным: AWS предложила пары трансмонов (2022-08) [S][263], Yale — резонаторы (2022-12) [S][315], и обе схемы продемонстрированы в июле 2023 г. [D][316], [317].
...
Производный такт = сумма раунда синдрома: слои гейтов + транспорт + считывание + сброс: 2.8×10⁻⁶ s на dual-rail-пути — четыре слоя CZ по 5.0×10⁻⁷ s [D][79] поверх проверки за 4.0×10⁻⁷ s [D][80], — и на резонаторном, и на трансмонном маршруте такт задают гейты. Уход с этого кодирования дёшев в аппаратуре и дорог в программной части: декодер, калибровка и бенчмарки предполагают наличие гералдов. Соседние пустые слоты: *логическая* dual-rail-память на повторяющихся раундах и код со смещением под стирание, потребляющий гералды и это смещение.
...
|---|---|---|---|---|
| Quantum Circuits Inc. (подразделение D-Wave) | разработчик | США | резонаторный dual-rail; Seeker; дорожная карта DR17–DR181 | [D][79] [C][81] [G:DWAVE-QCI-2026-01] |
| AWS Center for Quantum Computing | разработчик | США | трансмонный dual-rail; проверка с симметричным считыванием | [D][316] [G:AWS-ERASURE-2026-04] |
| Yale University | исследования | США | источник резонаторного кодирования; C2QA | [D][315], [317], [319] [G:DOE-NQISRC-2025-11] |
| PsiQuantum | разработчик | США | фотонный dual-rail с кодированием по путям, 300 mm | [D][146] [G:PSIQ-QBI-C-2026-07] |
| SUSTech | исследования | Китай | четыре двухрельсовых трансмона; логическое состояние Белла, CNOT | [D][322] [G:SUSTECH-DUALRAIL-2025] |
| Oxford Quantum Circuits | разработчик | Великобритания | отраслевой обзор кубитов со стиранием | [S][318] [G:OQC-SERIESC-2026-06] |
| UMass Amherst | исследования | США | кубит со стиранием на трансмонном кутрите | [D][321] |
| ORCA Computing | разработчик | Великобритания | патенты на линейно-оптические GHZ-измерения на dual-rail | [G][323] |
...
- 2025-11-06 · DARPA QBI, этап B · до $15 M каждому, одиннадцать команд, ни одного dual-rail-поставщика [G][60] [G:QBI-STAGEB-2025-11]
...
- 2026-06-03 · Oxford Quantum Circuits · раунд Series C · £260 M · Bullhound · закрыт [C][57] [G:OQC-SERIESC-2026-06]
...
- 2026-08-06 · D-Wave · Q2-2026 · выручка $3.1 M, денежные средства $546.2 M, грант NSF $1.57 M · отчёт опубликован [C][15] [G:DWAVE-Q2-2026-GATEMODEL]

**Рынок и цепочка поставок.** Само кодирование не продаёт никто; оно оценивается как аппаратная кратность — две моды плюс вспомогательный кубит на узел — плюс тракт считывания, читающий гералд. На сверхпроводниках это 2–3-кратная площадь кристалла либо механически изготовленная резонаторная сборка без фабричного маршрута, поэтому значимыми поставщиками оказываются производители рефрижераторов и усилителей, находящиеся под контролем BIS [G][225]. В фотонике оно бесплатно, а спецификация материалов — это фабрика, коммутатор и детектор. Сегодня платит G2 — за постселектированную точность, именно её и продаёт Seeker [C][81]; G3 и G4 заплатят, когда коды пойдут на 10⁵–10⁶ раундов; G6 платит со стороны фотоники; G1, G5 и G7 не платят.

**ИС и стандарты.** Патент Amazon Technologies US 11,748,652 B1 на геральдирование распада с амплитудным затуханием для QEC (выдан 2023-09-05) покрывает трансмонное воплощение [G][266] [G:AMZN-ERASURE-PATENT]; патент Yale US 12,288,135 на обработку с асимметричным каналом ошибок (выдан 2025-04-29) относится к резонаторным семействам, перешедшим к D-Wave в январе 2026 г. [G][324]; ORCA Computing владеет US 12,437,225 на линейно-оптические кодированные GHZ-измерения (2025-10-07) [G][323]. Датированного подсчёта патентных семейств из именованной базы данных получить не удалось; стандарта не существует, а де-факто интерфейсом декодера служит HERALDED_ERASE в Stim [P][313].

**Дорожные карты и послужной список.**
- D-Wave/Quantum Circuits: обещано 2026-06-01, переформулировано 2026-08-06 · DR17 (17 кубитов, двукратное снижение логической ошибки) в 2026 г., DR49 с 20× в 2027 г., DR181 с 2,000× в 2028 г., 10 логических в 2030 г., 100 логических в 2032 г., Λ = 10 · по состоянию на 2026-09-03 не выполнено [R][325] [G:DWAVE-QCI-2026-01].
...
- AWS: dual-rail-продукта не обещала · выдала три статьи в 2022–2026 гг. [D][80], [316]. Oxford Quantum Circuits: TITAN объявлен вместе с раундом Series C · датированной цели по dual-rail нет [C][57].
...
- Постселектированная ошибка Паули двухрельсового CZ 2026 г.: 0.029(6)% на гейт (цитируется по Nature 656, 47) против «< 0.1%» в аннотации arXiv и «границы 0.12% на глубине» в основном отчёте [D][79]; величины «на гейт» и экстраполированные по глубине не согласованы, доступного полного текста нет.
...
- Потери в волноводе PsiQuantum: 0.5 dB/m (основной отчёт) против 1.8(2) dB/m для одномодового SiN (Nature) [D][146]; вероятно, речь о разных классах волноводов; вопрос не закрыт.
...
- Заявленные Quantum Circuits накладные расходы «физические на логический» (в других местах приводимые как 10–20 физических на один логический) на разъясняющей странице компании по dual-rail не указаны [C][327]; датированного первичного числа не найдено.
...
- Взгляд OQC на кубиты со стиранием [S][318] — это обзор промышленной группы, а не аппаратное обязательство; в релизе OQC о раунде Series C цель по dual-rail не названа [C][57].
