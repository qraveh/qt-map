...
| Quantum Brilliance | разработчик | Австралия | Блоки комнатной температуры | [P][5] |
| Photonic Inc. | разработчик | Канада | Управление спинами T-центров | [P][4] |
| Element Six | поставщик | Великобритания | Рыночный CVD-алмаз | [P][6] |

**Деньги.** 2026-05-12 · Photonic Inc. · вхождение в капитал · USD 200 M при оценке USD 2 B · Microsoft снова среди инвесторов · закрыто [C][G:PHOTONIC-200M-2026-05]. 2026-07 · QuantumDiamonds · EUR 91 M, из них EUR 76 M по EU Chips Act · закрыто [P][6]. 2025-01 · Quantum Brilliance · Series A · USD 20 M · ~USD 58 M накопленным итогом · закрыт [P][6]. Ни один этап QBI этот механизм гейта не называет.
...
- Площадки развёртывания Quantum Brilliance названы без дат [5]; финансирования в 2025–2026 гг. сверх Series A января 2025 г. не обнаружено.
