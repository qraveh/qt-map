...
|---|---|---|---|
| 2024-05-15 | имплантированные SiV-узлы нанофотоники с 0.69(7) через 35 км волокна | Harvard | [D][2] |
| 2026-01-15 | волоконный микрорезонатор вокруг объёмного NV поднимает сбор с ~0.05% до ~0.5% | QuTech | [D][3] |
...
| Element Six | поставщик | Великобритания | Коммерческие CVD-пластины алмаза | [C][4] |
| Harvard | исследования | США | Имплантированная SiV-нанофотоника | [D][2] |
| Quantum Brilliance | разработчик | Австралия | Установки, работающие при комнатной температуре | [P][5] |
| QuantumDiamonds | разработчик | Германия | NV-микроскопия, Мюнхен | [P][5] |

**Деньги.** 2026-07 · QuantumDiamonds · грант и капитал · EUR 91 M, из них EUR 76 M по EU Chips Act · финансирование мюнхенского производства на EUR 152 M · сделка закрыта [P][5]. 2025-01 · Quantum Brilliance · раунд A · USD 20 M · ~USD 58 M накопленным итогом · сделка закрыта [P][5]. Ни одна стадия QBI не называет алмазное производство.
...
**Дорожные карты и послужной список.** QuTech (программа модульных вычислений · в графике) [D][1]. QuantumDiamonds (мюнхенское производство, 2026-07 · слишком свежо для оценки) [P][5]. Quantum Brilliance (установки в трёх лабораториях · поставлены, даты не указаны) [P][5]. Ни один актор не публикует датированной цели по выходу годных.
...
- Страница продуктов Element Six по квантовым технологиям вернула 404 на 2026-09-04; датированных показателей мощности, выручки или инвестиций конкретно по её квантовому сегменту не найдено, а статус единственного поставщика опирается на вторичный обзор [5].
