...
|---|---|---|---|---|
| QuTech | исследования | Нидерланды | Изготовление SnV-нанорезонаторов, данные по выходу годных | [D][294] |
| Element Six | поставщик | Великобритания | Коммерческие CVD-пластины алмаза | [C][293] |
| Harvard | исследования | США | Имплантированная SiV-нанофотоника | [D][177] |
| Quantum Brilliance | разработчик | Австралия | Установки, работающие при комнатной температуре | [P][296] |
| QuantumDiamonds | разработчик | Германия | NV-микроскопия, Мюнхен | [P][296] |

**Деньги.** 2026-07 · QuantumDiamonds · грант и капитал · EUR 91 M, из них EUR 76 M по EU Chips Act · финансирование мюнхенского производства на EUR 152 M · сделка закрыта [P][296]. 2025-01 · Quantum Brilliance · раунд A · USD 20 M · ~USD 58 M накопленным итогом · сделка закрыта [P][296]. Ни одна стадия QBI не называет алмазное производство.
...
**Дорожные карты и послужной список.** QuTech (программа модульных вычислений · в графике) [D][294]. QuantumDiamonds (мюнхенское производство, 2026-07 · слишком свежо для оценки) [P][296]. Quantum Brilliance (установки в трёх лабораториях · поставлены, даты не указаны) [P][296]. Ни один актор не публикует датированной цели по выходу годных.
...
- Выход годных 327 SnV-приборов опубликован как институциональная новость [294]; лежащая в основе рецензируемая статья не найдена, поэтому цифра остаётся односточниковой и невоспроизведённой.
- Страница продуктов Element Six по квантовым технологиям вернула 404 на 2026-09-04; датированных показателей мощности, выручки или инвестиций конкретно по её квантовому сегменту не найдено, а статус единственного поставщика опирается на вторичный обзор [296].
