...
## Роль в стеке
Узел требует спинового регистра на центре окраски и однофотонного детектирования; без детекторов с низким темпом тёмных отсчётов геральдирование не работает вовсе. Он ничего не обеспечивает выше по стеку и венчает сетевой путь на дефектных спинах. В любой распределённой архитектуре именно он задаёт темп: производный такт = max(гейт, считывание, транспорт) равен 45 s при городском темпе Delft и 1.0 s в лучшем результате Harvard. Значимо здесь сравнение с конкурирующим интерконнектом: оксфордская линия на ионах в ловушке дала белловскую точность 96.89(8)% при 9.7 s⁻¹ и телепортированный CZ с 86.2(9)% [D][G:OXFORD-DISTRIBUTEDQC-2025-02] — на порядок быстрее и на 30 пунктов лучше. Контраргумент твердотельного подхода — технологичность изготовления, а не характеристики.
