...
| Microsoft | Разработчик | США | Измерение чётности в тетронах с настройкой напряжениями на затворах | [D][4] |
