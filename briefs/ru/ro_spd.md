...
Сверхпроводящая нанопроволока, смещённая током, поглощает один фотон, образует резистивное горячее пятно и выдаёт импульс напряжения; датчик на краю сверхпроводящего перехода (TES) вместо этого измеряет поглощённую энергию калориметрически и потому разрешает число фотонов. Группа Gol'tsman в Moscow State Pedagogical University продемонстрировала первое устройство на NbN в 2001 году [D][472]; TES со смещением по напряжению восходит к работе Irwin (1995) [D][473]. Компания Scontel, по-прежнему находящаяся в Москве, происходит напрямую от той первой группы.
...
|---|---|---|---|---|
| PsiQuantum | разработчик | США | Собственные SNSPD, монолитно встроенные в Omega на 300 mm GlobalFoundries, медиана 93.4% | [D][146] |
| Single Quantum | поставщик | Нидерланды | Системы SNSPD «под ключ»; 400-я отгружена Q*Bird 2026-07 | [P][467] |
| ID Quantique | поставщик | Швейцария | SNSPD и детекторы InGaAs плюс QKD; приобретена IonQ 2025-05-06 | [P][479] |
| Photon Spot | поставщик | США | SNSPD плюс собственные криостаты Cryospot; КЭ >90%, джиттер менее 100 ps | [C][476] |
| Quantum Opus | поставщик | США | Opus One, ≥90% на 1310/1550 nm, >2 K, разрешение по числу фотонов по лицензии | [C][477] |
| Scontel | поставщик | Россия | Линейки SSPD большой площади, сверхнизкошумящих и с разрешением по числу фотонов | [C][480] |
| NIST Boulder | исследования | США | Рекорд эффективности 98.0%, плёнки WSi, камера на 400 kpixel, калибровка | [D][269], [464] |
| JPL | исследования | США | Рекорд джиттера 2.7 ps; матрицы для оптической связи дальнего космоса | [D][475] |
| Nanjing University | исследования | Китай | Каскадная эффективность на кристалле 99.73% | [D][474] |
| Xanadu | пользователь | Канада | Путь непрерывных переменных опирается на гомодин; разрешение по числу фотонов только для GKP | [D][149] |
| Bluefors | поставщик | Финляндия | Криогенные платформы; KIDE, девять криокулеров на импульсных трубах, >4,000 РЧ-линий | [C][228] |

**Деньги.**

- 2025-05-06 · IonQ / ID Quantique · сделка M&A · сумма в цитируемых релизах не раскрыта · — · закрыта [P][479]
- 2025-09-10 · PsiQuantum · Series E · $1 B при оценке $7 B · BlackRock, Temasek, Baillie Gifford · закрыт [G:PSIQ-1B-2025-09]
- 2025-11-06 · DARPA QBI Stage B · программа · до $15 M на участника, 11 исполнителей, включая Xanadu и Photonic Inc. · DARPA · присуждено [G:QBI-STAGEB-2025-11][60]
- 2026-03-26 · Xanadu · закрытие сделки SPAC · ~$302 M валовых, ~40% ниже плана · Crane Harbor · закрыта [G:XANADU-SPAC-2026-03]
- 2026-05-21 · PsiQuantum · протокол о намерениях по CHIPS · $100 M · Министерство торговли США · LOI (необязывающий) [G:CHIPS-LOI-2026-05][224]
- 2026-06-16 · Quandela · DARPA QBIT Stage A · сумма не раскрыта · DARPA · объявлено [G:QBI-QBIT-2026]
- 2026-07-04 · Single Quantum · поставлена 400-я система SNSPD · выручка не раскрыта · Q*Bird · сообщено [P][467]
- 2026-07-22 · PsiQuantum · расширение DARPA QBI Stage C (коммутаторы, корпусирование, верификация и валидация криогеники) · $125 M, после $31.8 M в 2025-09 · DARPA · объявлено [P][G:PSIQ-QBI-C-2026-07][157]
- 2026-08-28 · Xanadu · финансирование канадского завода · CAD 195 M · федеральная программа · объявлено [C][154]
...
**Рынок и цепочка поставок.** Цены не публикует ни один поставщик [C][476], [477], [480], поэтому удельная экономика непроверяема. Платёжеспособный спрос сегодня — это сетевой G6, то есть QKD, где живут 400 систем Single Quantum и линейка ID Quantique, плюс неквантовый якорь в развёртываемых системах G7 (оптическая связь дальнего космоса и лунная; среди названных заказчиков NASA, NIST, Fermilab, Sandia и Argonne [C][476], [477]). G3/G4 платит только через PsiQuantum, Xanadu, Quandela, QuiX и Photonic Inc. Риск концентрации лежит выше по цепочке: криоголовки, гелий, криогенный коаксиал.

**ИС и стандарты.** Quantum Opus владеет исключительной лицензией на US 11,274,962 B2 в части разрешения по числу фотонов [C][477]. Датированного числа патентов из поименованной базы для этого узла по состоянию на 2026-09-03 найти не удалось. Стандарта, специфичного для SNSPD, не существует; прослеживаемость калибровки де-факто обеспечивает NIST [D][269], [464].

**Дорожные карты и послужной список.** PsiQuantum (обещано с 2021 года · полезная система к концу 2027 года · под угрозой: закладка в Брисбене только 2026-06, криогенная установка во 2H 2027, аппаратных демонстраций 2026 года не опубликовано) [P][157]. Xanadu (обещано 2026-08-31 · потери в 24.1× выше порога в 2026 году → 1.0× в 2030 году, 1,000+ логических кубитов к 2031 году · дорожная карта пока только на бумаге) [C][154]. Single Quantum (публичной дорожной карты нет; 400 поставленных систем — единственный датированный показатель) [P][467]. Достоверность: поставщики детекторов обещают меньше, чем поставляют; физика детекторов у PsiQuantum достоверна, а её график — нет; дорожной карте Xanadu три недели, и она не проверена.
