...
- 2026-06-29 · SEEQC · форма S-1 для обычного IPO на Nasdaq (SEQC), подана параллельно соглашению о SPAC-слиянии с Allegro Merger Corp (оценка предприятия $1 B, PIPE на $65 M) · размер размещения не определён · подана [P][9][G:SEEQC-S1-2026-07]
