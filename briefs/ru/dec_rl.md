...
|---|---|---|---|---|
| Google Quantum AI | разработчик | США | Управление на RL, AlphaQubit2, Willow | [D][2] |
| Google DeepMind | разработчик | Великобритания | Нейросетевые декодеры, линия AlphaQubit | [D][496] |
| Q-CTRL | поставщик | Австралия | Калибровочное ПО Boulder Opal | [C][551] |
| IQA Shenzhen | исследования | Китай | Единственное живое нейросетевое декодирование в замкнутом контуре | [D][537] |

**Деньги.**
2024-10-08 · Q-CTRL · расширенный раунд Series B · USD $113 M (AUD $166 M) · ведущий инвестор GP Bullhound · закрыт [C][551]
...
**Рынок и цепочка поставок.** Рынка компонентов нет; оцениваемый заменитель — калибровочное ПО плюс такты GPU/TPU, которые продаёт только Q-CTRL, на платформах Diraq, Oxford Quantum Circuits и Rigetti [C][551]. Платит по G3/G4.
...
**Дорожные карты и послужной список.** Следующий рубеж Google, долгоживущий логический кубит на уровне 10⁻⁶ (без даты): 7.72×10⁻⁴ при d=7 отстоит от него на три порядка и требует d≈25 при Λ≈2 [D][1]; в QBI Stage B Google отсутствует [G]. Q-CTRL поставила Boulder Opal на трёх платформах к 2024-10 — выполнено, но в масштабе, несопоставимом с гугловским.
...
- Цифры «~20% снижения логической ошибки» и «>1,000 живых параметров управления» встречаются только в отраслевой прессе [550]; аннотация статьи приводит 3.5× и десятки тысяч параметров в моделировании.
