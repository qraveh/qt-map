...
Атрибуты. **Подвижность: летающий носитель** — запутывание несёт фотон, а не ион. **Модальность управления и её размещение: оптическая, комнатная температура** — сбор света, интерференция и детектирование находятся вне вакуумной оболочки ловушки.
...
| 2025-06 | Поглощена Lightsynq (фотонный интерконнект + квантовая память, >20 патентов и заявок) | IonQ | [C][3] |
| 2026-04 | Связаны две коммерческие ионные системы; ни скорость, ни точность, ни расстояние не раскрыты | IonQ | [C][4] |
...
| IonQ | разработчик | США | Объединила по сети две системы; владеет Lightsynq и ID Quantique | [C][4] |
| Quantinuum | разработчик | США | Масштабируется внутриловушечным транспортом; обязательств по фотонике нет | [D][6] |
...
| AFRL | пользователь | США | Партнёр по апрельской вехе IonQ 2026 года | [C][4] |
...
- 2025-06-03 · IonQ · сделка M&A, Lightsynq (интерконнект, квантовая память, >20 патентов) · сумма не раскрыта · основатели из Harvard/AWS · закрыта [C][3]
- 2025-09-17 · IonQ · сделка M&A, Oxford Ionics · $1.075 B · — · закрыта [C][8]
- 2025-11-06 · DARPA · QBI, этап B · до $15 M каждому · IonQ и Quantinuum в числе одиннадцати [G][7]
- 2026-06-03 · Quantinuum · IPO, Nasdaq QNT · $1.68 B валовых поступлений · — · закрыто [G][9]
- 2026-07-31 · IonQ · сделка M&A, SkyWater Technology · ~$1.8 B · — · закрыта [C][10]
...
**ИС и стандарты.** Единственный датированный факт по ИС — заявление IonQ о том, что вместе с Lightsynq пришли «более 20 патентов и патентных заявок» в области фотонного интерконнекта и квантовой памяти: корпоративный подсчёт без названий семейств, правообладателей и годов подачи [C][3]. Ни одного названного патентного семейства по аппаратуре линии ион — фотон не найдено; никакой орган по стандартизации её не регулирует.

**Дорожные карты и послужной список.** IonQ (обещано 2025-06 · 2 M физических и 40–80 k логических кубитов к 2030 г. · статус на 2026-09-03: требуется интерконнект на два порядка быстрее любой опубликованной скорости) [R][11]; её дорожная карта 2020 года промахнулась мимо 4,000 кубитов к 2026 г. примерно в 40 раз. Quantinuum (обещано 2024-09 · Sol в 2027 г., Apollo в 2029 г. · датированных обязательств по фотонному интерконнекту нет) [R][12]; Helios вышел в срок, поэтому её даты имеют вес.
...
- Апрельская веха IonQ 2026 года [4] не раскрывает ни скорости, ни точности, ни расстояния, а её формулировка («подтвердила генерацию, передачу и детектирование фотонов, используемых для получения квантовой запутанности») не утверждает, что белловская пара была измерена.
