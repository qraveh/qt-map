...
|---|---|---|---|---|
| PsiQuantum | разработчик | США | Наивысшая опубликованная белловская точность между кристаллами на 42 м | [D][1] |
| Xanadu | разработчик | Канада | Система из 35 кристаллов, объединённых волокном; эталон по стыковке | [D][2] |
| Quandela | разработчик | Франция | Введена в эксплуатацию 12-кубитная Lucy, состыкованная с HPC Joliot-Curie | [C][5] |
| Corning | поставщик | США | Волоконные сборки для корпусирования фотонных кристаллов | [C][4] |
