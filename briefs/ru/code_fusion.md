...
| 2025-06 | Порог по потерям от 2.7% (усиленное 6-кольцо) до 17.4% ({7,4}) | теория | [S][1] |
| 2026-06 | Пол от отказов слияния при нулевых потерях; порог 7.0–7.3% с излучателем | Sparrow | [S][2] |

В межплатформенной таблице отчёта фотоника набирает ноль по каждому примитиву отказоустойчивости: нет подпорогового масштабирования, нет логического кубита за точкой безубыточности, нет логического двухкубитного гейта, декодирование только на уровне обнаружения [D][4].
