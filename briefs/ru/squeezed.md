...
|---|---|---|---|---|
| Xanadu | разработчик | Канада | Единственный актор, эксплуатирующий CV/GKP-системы на кристалле | [D][3] |
