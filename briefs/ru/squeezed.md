...
|---|---|---|---|---|
| Xanadu | разработчик | Канада | Единственный актор, эксплуатирующий CV/GKP-системы на кристалле | [D][150] |
...
Независимая цифра по сжатию на кристалле существует: Shi и соавт. сообщают о 1.4 дБ, измеренных на PPLN TFLN [275]. На единственном источнике остаётся *эффективное сжатие GKP* 0.62 дБ (только Xanadu).
