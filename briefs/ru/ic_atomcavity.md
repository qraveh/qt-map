...
| Nu Quantum | поставщик | Великобритания | Интерфейс кубит — фотон и блоки фотонных сетей | [C][8] |
| Cisco | поставщик | США | Оборудование квантовых сетей и ПО распределённых вычислений | [P][9] |

**Деньги.**
2025-07-17 · QuNorth · заказ «Magne» у Atom Computing/Microsoft · EUR 80 M · 50 логических кубитов · заказано [G][10]
2025-11-06 · DARPA · QBI Stage B, Atom Computing и QuEra в числе одиннадцати · до USD 15 M каждому · официально [G][11]
2025-12-10 · Nu Quantum · раунд Series A · USD 60 M · ведущий инвестор National Grid Partners, с Amadeus, IQ Capital, NSSIF, Sumitomo/Presidio · закрыт [C][8]
2026-05-21 · US Dept of Commerce · письмо о намерениях по CHIPS, Atom Computing · USD 100 M · необязывающее LOI [G][12]
2026-06-16 · Atom Computing · раунд Series C (Third Point) · USD 100 M · суммарно > USD 300 M · закрыт [G][13]

**Рынок и цепочка поставок.** Рынка нет: резонаторный интерфейс атом — фотон никто не продаёт, а деньги здесь либо процессорные (Atom Computing), либо смежные сетевые (Nu Quantum, Cisco). Единственная компания, прицельно занимающаяся именно этой функцией, — Nu Quantum, и это компания с USD 60 M привлечённых средств и без опубликованных скорости и точности [C][8]. Правдоподобное узкое место — поставка детекторов и фотонная интеграция. Сегодня узел оплачивает G6, а если он заработает — G4 и G7; ни за одну из G1–G3 он не платит.
...
**Дорожные карты и послужной список.** В дорожной карте Nu Quantum два пункта — Qubit–Photon Interface на 2024 г. и Quantum Networking Unit на 2025 г., — и ни по одному не указаны ни скорость, ни точность [C][8]. Соглашения Atom Computing — Nu Quantum (2026-06-17) и Atom Computing — Cisco (2026-03-25) не несут датированных целей [P][5][P][9]; цель Osaka на ~100 каналов даты не имеет [P][3]. По состоянию на 4 сентября 2026 г. ни у одного из здешних акторов нет обещания, достаточно конкретного, чтобы его оценивать, — и это само по себе вывод.
