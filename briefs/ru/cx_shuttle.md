...
|---|---|---|---|---|
| QuTech | исследования | Нидерланды | Все конвейерные спиновые рекорды: линия 10 µm, гейт движущихся спинов, подвижный анцилла | [D][2], [3], [8] |
| RWTH Aachen | исследования | Германия | Изобрели конвейерный режим; архитектура SpinBus | [D][1][S][7] |
| Forschungszentrum Jülich | исследования | Германия | Соавтор конвейера; размещает первую систему ARQUE | [C][11] |
| ARQUE Systems | разработчик | Германия | Продаёт запатентованные шаттлинговые тракты; пятикубитный процессор | [C][11] |
| IBM | разработчик | США | Приобрела HRL: кремний на одном лишь обмене плюс 4 K cryo-CMOS | [G][12] |
| Diraq | разработчик | Австралия | 300 mm кремниевый MOS совместно с imec; разреженные топологии лежат в основе её заявлений о стоимости | [D][9] |
| Quantum Motion | разработчик | Великобритания | CMOS 22FDX, полностековая система в NQCC | [C][13] |
| imec | поставщик | Бельгия | 300 mm спиновая линия; изготовила бы любой фабричный конвейер | [D][9] |

**Деньги.**
- 2022-09 · ARQUE Systems · спин-офф, основанный Bluhm и тремя коллегами · сумма не раскрыта · Jülich, RWTH Aachen · объявлено [C][11]
- 2025-11-06 · DARPA QBI Stage B · одиннадцать команд, включая Diraq и Quantum Motion · до $15 M каждой · объявлено [G][14][G:QBI-STAGEB-2025-11]
- 2026-05-07 · Quantum Motion · раунд серии C · $160 M · DCVC, Kembara · закрыт [C][13][G:QM-160M-2026-05]
- 2026-05-21 · Diraq · письмо о намерениях по программе CHIPS · до $38 M · US Commerce · LOI [G][15][G:CHIPS-LOI-2026-05]
- 2026-06-03 · Quobly · раунд серии A · €115 M · Bpifrance, SEALSQ, STMicroelectronics · закрыт [C][16][G:QUOBLY-115M-2026-06]
- 2026-07-23 · IBM · приобретение HRL Laboratories · сумма не раскрыта · закрытие сделки намечено на конец Q3 2026 · объявлено [G][12][G:IBM-HRL-2026-07]
...
**ИС и стандарты.** Семейство конвейерных решений происходит из RWTH Aachen и Forschungszentrum Jülich; ARQUE коммерциализирует запатентованный механизм шаттлинга [C][11]. Датированного счёта патентных семейств из поименованной базы данных для этого узла не существует, поэтому он и не приводится, а спиновый транспорт не покрыт ни одним органом по стандартизации.

**Дорожные карты и послужной список.** (обещано 2021-08 · конвейер как масштабируемая шина · статус на 2026-09-03: только уровень одиночного канала, ни разу не на фабричной пластине). (ARQUE Systems, обещано 2026 · пятикубитный шаттлинговый процессор в Jülich · статус: идёт установка, приёмочных данных нет [C][11]). (QuTech, обещано 2026-07 · шаттлинговая чётность выше 99% за счёт смены затворного стека · статус: 97.7% на переброс [D][8]). (Diraq, обещано 2026-08-27 · 150 k физических и 1 k логических кубитов к 2029 · статус: восьмикубитное фабричное устройство с одной работающей парой, при том что её собственный июльский релиз говорит о «тысячах к 2029» [C][G:DIRAQ-FUNDING][G:DIRAQ-8Q-2026-07]). QuTech — сильнейший актор здесь; ARQUE не доказала ничего, но это единственный носитель обязательства с датой поставки; цифры Diraq движутся быстрее, чем её устройства.
...
- Финансирование ARQUE Systems: ни раунда, ни суммы, ни инвестора в релизе Forschungszentrum Jülich не раскрыто [11]; страницы компании и баз данных для него не цитируются. Численность персонала и датированная веха по установке в Jülich Supercomputing Centre также не верифицированы.
- arXiv:2503.10601 [7]: список авторов, организация и дата для него недоступны; приведённые пороговые цифры взяты только из текста аннотации.
- arXiv:2605.00611 [6]: аннотация машинно не читается; цитируется только по названию, количественных утверждений из неё не взято.
...
- Конфликт источников, незначительный: «99.5%» (аннотация) против «99.54 ± 0.03%» (чередующийся рандомизированный бенчмаркинг) в [2] — это одно и то же измерение; настоящая справка использует 99.54%. Межплатформенный: германиевые «99.97% на переброс» [5] — цифра по базисным состояниям, не сопоставимая со спиновой точностью кремниевого конвейера [2].
