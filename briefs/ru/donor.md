...
Одиночный донор ³¹P, размещённый атом за атомом в обогащённом ²⁸Si: связанный электрон даёт возбуждение и спин-зарядовое считывание, ядро ³¹P со спином 1/2 — память. Гейты над ядерными кубитами внутри регистра выполняются через их сверхтонкую связь с *общим* электроном; регистры связываются между собой электронным обменом [D][1]. Архитектуру предложил Kane в 1998 году; группа Simmons в UNSW построила первое устройство с детерминированно размещённым одиночным донором в 2012 году [D][2]; SQC, её спин-офф 2017 года, по состоянию на 4 сентября 2026 г. остаётся единственным, кто работает на уровне приборов.
...
**Рынок и цепочка поставок.** Установку для размещения атомов на STM на рынке никто не продаёт: актив SQC — это ноу-хау, поэтому второй источник купить негде. ²⁸Si — единственный вход с двумя поставщиками [P][3]; стоимость в расчёте на один донор не публикуется. Работает на G2 и G3 по точности, а не по числу кубитов.
...
- «99.90% для CZ на донорном ядерном спине» из основного отчёта из [1] не вычленяется; формулировки в препринте (99.5–99.99%) и в публикации (99.10–99.99%) к тому же расходятся. Здесь трактуется как диапазон.
