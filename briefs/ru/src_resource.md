...
Подсистема «источник + слияние (fusion)», которая обязана изготавливать с темпом кода кодированные графовые состояния — канонически 6-кольцо, — потребляемые и разрушаемые отказоустойчивостью на основе слияний. Слияние типа II по Browne–Rudolph (2005) сделало это возможным; Bartolucci и соавт. закрепили 6-кольцо в качестве эталонного ресурса и задали его бюджет потерь [S][3]. Лучшая реализация: MPQ Garching слила детерминированно испущенные фотоны в 6-кольца и 7-деревья, 8 фотонов, 0.4–2.3 совпадения в минуту [D][1]. Атрибуты: летящие фотоны от изготовленных излучателей, геральдированное (heralded) запутывание, отсутствие фиксированного такта; электрооптическое управление при комнатной температуре, ошибки чистых потерь, изготовление фотонных ИС.
