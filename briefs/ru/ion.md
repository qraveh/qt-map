...
Производный такт = max(гейт, считывание, транспорт). На пути QCCD доминирует транспорт: ≈ 5.5×10⁻² с на слой полной ширины, ≈ 18 слоёв/с [D][1][12]. На пути электронных гейтов при малом числе ионов такт составляет ≈ 2.3×10⁻⁴ с и задаётся гейтом [D][4]. Этот разрыв в два порядка — определяющее число платформы. Соседний пустой слот: криогенный интегрированный на чипе слой возбуждения для ионных ловушек — аналог SFQ/cryo-CMOS — не имеет ни одного решения продуктового масштаба.
