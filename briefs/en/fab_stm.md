...
|---|---|---|---|
| 2012 | first single-atom transistor from a deterministically placed donor | UNSW | [D][288] |
| 2025-12-17 | 11 qubits (9 nuclear, 2 electron ancilla), gates 99.10–99.99%, Bell to 99.5%, GHZ over eight nuclei | SQC | [D][165][G:SQC-11Q-2025-12] |
...
**Roadmaps & track record.** SQC (2026-06 · commercial scale by 2033 [R][G:SQC-NRFC-2026] · unmet, eleven qubits published). "Continuous scaling" and "a million qubits" appear in company material with no published mechanism [C][290], so the target is unfalsifiable rather than ambitious.
