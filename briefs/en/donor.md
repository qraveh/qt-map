...
## Identity & lineage
A single ³¹P donor placed atom-by-atom in enriched ²⁸Si: the bound electron gives drive and spin-to-charge readout, the spin-1/2 ³¹P nucleus the memory. Nuclear qubits inside a register are gated through their hyperfine coupling to a *shared* electron; registers are linked by electron exchange [D][165]. Kane proposed the architecture in 1998; UNSW's Simmons group built the first deterministically placed single-donor device in 2012 [D][288]; SQC, its 2017 spin-out, is the sole operator at device scale as of 4 Sep 2026.
...
|---|---|---|---|
| 2012 | first deterministically placed single-donor device | UNSW | [D][288] |
| 2025-12-17 | 11 qubits (9 nuclear, 2 electron ancilla), gates 99.10–99.99%, Bell to 99.5%, GHZ over eight nuclei | SQC | [D][165] |

Dominant term: register size and the electron-mediated gate. The main report's single "99.90% donor nuclear CZ" is not isolable from this work [D][165].

## Manufacturing, materials & supply chain
Serial by construction: one tip, one site, so throughput is qubit-hours, not wafer-hours; no parallel exposure is published. Enriched ²⁸Si is dual-sourced as of 4 Sep 2026 — ASP Isotopes' Pretoria line since 2025-03, US DOE silane at 99.9999% ²⁸Si from 2026-07-16 [P][278] — so feedstock is not the constraint. Suppliers: SkyWater for US resonators [C][289], Bluefors for cryogenics [C][290]. The single point of failure moved in 2026: IonQ closed its ~USD 1.8 B purchase of SkyWater on 2026-07-31 [G][18], putting SQC's only named US manufacturing route inside a competitor. Export exposure is nil today — 4A906 bites only above 34 qubits [G][225]. Wiring is not the wall; the write step is.

## Role in the stack
Requires STM hydrogen lithography; provides the carrier for exchange links and spin-to-charge readout; substitutes for gate-defined dots at the cost of the whole process flow. Its clock contribution is not distinctive — µs gates and ~6 µs readout match dot spins, so sum of the syndrome round: gate layers + transport + readout + reset is 7.7 µs against their 8.5 µs, and the real bottleneck is a manufacturing quantity the clock cannot express. Verification: one group, one device, no replication, three inconsistent fidelity framings [D][165].

## Actors & economics
**Who.**
| Organisation | Role | Country | What exactly they do | Evidence |
|---|---|---|---|---|
| SQC | developer | Australia | Sole STM donor fabricator, 11-qubit processor | [D][165] |
| SkyWater Technology | supplier | USA | Resonators, packaging | [C][289] |
| IonQ | supplier | USA | Owns SkyWater since 2026-07-31 | [G][18] |

**Money.** 2025-11-06 · SQC · QBI Stage B award · up to USD 15 M · DARPA · awarded [G:QBI-STAGEB-2025-11]. 2026-03-24 and 2026-06-11 · SQC · equity · A$60 M combined · Australia's NRFC · closed [G:SQC-NRFC-2026]. 2026-07-31 · IonQ · acquisition of supplier SkyWater · ~USD 1.8 B · closed [G][18].

**Market & supply chain.** No merchant sells an STM placement tool: SQC's asset is know-how, so no second source can be bought. ²⁸Si is the one input with two suppliers [P][278]; cost per donor is unpublished. Pays into G2 and G3 on fidelity, not count.
...
[278] U.S. Department of Energy, “DOE Advances Domestic Supply of Silicon, Germanium Isotopes for Quantum Computing,” HPCwire, Jul. 16, 2026. [Online]. Available: https://www.hpcwire.com/off-the-wire/doe-advances-domestic-supply-of-silicon-germanium-isotopes-for-quantum-computing/ [P]
[288] M. Fuechsle *et al.*, “A single-atom transistor,” *Nat. Nanotechnol.*, vol. 7, no. 4, pp. 242–246, Apr. 2012, doi: [10.1038/nnano.2012.21](https://doi.org/10.1038/nnano.2012.21). [D]
[289] Silicon Quantum Computing, “SkyWater x SQC: Advancing Hybrid Quantum-Classical Computing,” Nov. 20, 2025. [Online]. Available: https://sqc.com/news/skywater-and-sqc-advancing-hybrid-quantum-classical-computing [C]
[290] Silicon Quantum Computing, “Silicon Quantum Computing — News,” sqc.com. [Online]. Available: https://sqc.com/news/ [C]

## Open verification items
- The main report's "99.90% donor nuclear-spin CZ" is not isolable from [165]; preprint (99.5–99.99%) and published (99.10–99.99%) framings also differ. Treated here as a range.
