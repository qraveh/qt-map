...
| D-Wave | developer | US | On-chip Φ-DAC control of a fluxonium | [D][3] |
| University of Maryland | research | US | Manucharyan-group 99.94% CNOT | [D][1] |
| S Lab, Shenzhen | research | CN | Single-channel unified flux control | [D][2] |
...
The PRX Quantum publication date of source [1] was not confirmed (volume/article number only); the arXiv date is used.
