...
CEA-Leti opened the route in 2016 with a spin qubit in a 28 nm FD-SOI flow [D][584]. Intel and QuTech made the first all-optically patterned 300 mm qubits in March 2022 [D][585], fixing *since 2022*; Intel added EUV arrays and 1.6 K wafer statistics in 2024 [D][172], [586]. imec produced 300 mm transmons in 2024 [D][217] and, with Diraq, unit cells above 99% in 2025 [D][162]. GlobalFoundries' 22FDX became the merchant option in 2025 [D][587], ST started 28Si FD-SOI lots in December 2025 [P][588], and US CHIPS letters of intent followed in May 2026 [G][224].
...
Mechanism. The fab fixes four inherited quantities: geometric uniformity, critical dimension within 0.5 nm at 45–100 nm pitch [D][172]; electrostatic disorder, a random threshold-voltage spread of 59 mV on Intel Si/SiGe [D][586]; isotopic purity, 800 ppm residual 29Si at Intel [D][172] and 400 ppm at imec [D][162]; and interface quality, which sets charge noise and, in Si/SiGe, the valley-splitting distribution.

Scales. T2*/T2echo reach 5/205 µs on 28Si Si/SiGe against 0.6/98 µs on natural silicon [D][586]; Hahn-echo T2 reaches 1.31 ms on imec SiMOS [D][170].

Floor. For spins it is material: residual 29Si, interface charge noise and the Si/SiGe valley-splitting tail that turns some dots into leakage sinks. For transmons it is junction targeting: 8% wafer-level resistance spread gives 5–7% frequency spread [D][217], an order above collision-free lattice needs; alternating-bias annealing (97.4% targeting [D][218]) is post-fab, not a foundry property.

As the code sees it: coherent, calibratable error (HRL attributes about 80% of CNOT error on its 54-dot array to control and calibration [D][163]) plus leakage and slow drift; nothing is erasure-convertible; wafer gradients [D][217] become spatially correlated error. Moving the floor needs 10-ppm-class 28Si, engineered valley splitting (simulation only [S][589]), Ge/SiGe holes or in-flow junction trimming.

## Engineering state of the art

Best demonstrated: four Diraq/imec unit cells, every operation above 99% (1Q 99.97%, CZ 99.04–99.56%, SPAM 99.95% at 100 µs), gate-set tomography, September 2025 [D][162][G:IMEC-300MM-2025]. Typical at scale: Intel's 232 twelve-dot devices on one wafer gave 99.8% dot and 96% full-device yield, May 2024 [D][586]; unmodified 22FDX gave 28–40% "good dot" yield over 1,024 dots, January 2025 [D][587]; imec's eight-qubit array validated one pair of four, July 2026 [D][170].

| year | figure | who | tag+key |
|---|---|---|---|
| 2016 | spin qubit in a 300 mm 28 nm FD-SOI flow | CEA-Leti | [D][584] |
| 2022-03 | >10,000 dot arrays per wafer; 1Q 99.0–99.1% | Intel/QuTech | [D][585] |
| 2024-09 | 300 mm transmons: median T1 75 µs, 98.25% yield | imec/KU Leuven | [D][217] |
| 2024-12 | >24,000 devices per wafer, CD < 0.5 nm (EUV) | Intel | [D][172] |
| 2025-01 | 1,024 dots on 22FDX, 1:1,024 cryo-CMOS mux, < 10 min | Quantum Motion/GF | [D][587] |
| 2025-09 | CZ 99.04–99.56% on 300 mm SiMOS, 4 of 4 devices > 99% | Diraq/imec | [D][162] |
| 2026-07 | 4 K CMOS controller (366 DACs, ≤ 3.5 W) runs d=5 repetition code, Λ = 4.7 | HRL | [D][163][G:HRL-2026] |

Dominant error term: the 2Q plateau at 99.0–99.6% is charge noise plus exchange calibration [D][162], [163]; 100 µs readout for 99.9%-class SPAM [D][162] sets a 100–300 µs cycle; no 300 mm device above twelve qubits has published all-pairs 2Q; for transmons the limit is junction spread, not coherence [D][217].

## Manufacturing, materials & supply chain

Platforms. Intel D1: Si/SiGe wells, immersion and EUV lithography, cryo-prober screening [D][172], [586]. imec: SiMOS with overlapping polysilicon gates below 100 nm pitch on 400 ppm 28Si [D][162], plus a transmon flow with dry-etched overlap junctions [D][217]. FD-SOI: GlobalFoundries 22FDX (Quantum Motion [D][587]; Equal1 [C][590]) and ST 28 nm at Crolles on Soitec 28Si substrates, first lots December 2025 [P][588]. HRL and SkyWater run 200 mm [D][163][C][18].

Yield. 96% device yield on a quantum-optimised flow [D][586] against 28–40% on a merchant flow [D][587] is this node's central number.

Cost and energy. No foundry publishes a quantum wafer price; Diraq's < $1 per qubit target [R][178] and vendors' rack-scale claims [C][173], [286], [591] are unaudited.

Supply chain. Lines: Intel (captive); imec, coordinator of the EU SPINS pilot line [G][592]; GlobalFoundries' Quantum Technology Solutions unit [C][284]; IBM Albany, becoming Anderon for superconducting wiring, TSVs and bumps [C][593]; SkyWater, 200 mm, IonQ-owned since 2026-07-31 [C][18]. Materials: enriched 28Si, historically Russian; Silex completed a plant for up to 20 kg per year in June 2026, commissioning late 2026, for SQC [C][594]. Equipment: cryogenic wafer probers from Bluefors/Afore (< 2 K, 300 mm, 768 DC, 48 RF lines) [C][595] and FormFactor [C][596]. Single points of failure: EUV dots only at Intel and imec; one 28Si plant; a prober duopoly.

Export control. BIS's rule of 2024-09-06 controls cryogenic CMOS ICs for ≤ 4.5 K (ECCN 3A901), cryogenic systems ≥ 600 µW at ≤ 0.1 K (3A904), cryogenic wafer probers (3B904) and quantum computers from 34 qubits (4A906), with License Exception IEC for allies [G][225][G:BIS-QUANTUM-2024]; EU and UK lists match.

## Control, readout & I/O burden

Multiplexing moves on-die or in-package: a 1:1,024 cryo-CMOS multiplexer on 13 lines [D][587]; imec's multiplexer routing transmon pulses below 15 mK with > 99.9% 1Q preserved [D][597]; a 32-cell 28 nm FD-SOI chip at 7 mK, ~20 nW/MHz per cell [D][419]; HRL's 4 K controller, 366 DACs at ≤ 3.5 W (~10 mW per channel), running a repetition code [D][163]; IBM's 4 K controller at 23 mW per qubit [D][220]. Crossbar sharing needs T = 6√g − 1 lines for a square array of g dots (23 for 16) [D][404].

Walls. 10³: per-qubit lines suffice; the burden is tune-up time. 10⁴: 10–23 mW per channel at 4 K means 100–230 W, beyond any cryostat's 4 K stage, forcing ≥ 10:1 multiplexing or millikelvin nW-class cells. 10⁶: only crossbar sharing (~6,000 lines [D][404]) plus millikelvin CMOS or SFQ closes; whether shared control keeps coherent error below threshold is open. Latency: spin cycles are readout-bound, 100 µs integration [D][162].

## Role in the stack

A layer-10 root: it requires nothing and provides the dot arrays and cryo-ASICs the spin path assumes. It replaces STM-lithography donor fabrication (11-qubit registers, serial, no foundry route [D][165]); for ion traps it is the alternative to MEMS trap fabs, the switching price being CMOS re-qualification, paid by Oxford Ionics (part of IonQ since 2025-09-17), whose 99.99% two-qubit fidelity on standard-fab chips is reported in an IonQ release [C][352][G:IONQ-OXIONICS-2025]. Off-diagonal reading: natural carriers (trapped ions) inheriting semiconductor manufacturing. Derived clock = sum of the syndrome round: gate layers + transport + readout + reset for the path; this node adds no term; the spin path's derived round is 8.5 µs, readout-set, against a measured 100–300 µs cycle [D][162]. Conveyor shuttling at 10 µm and 99.5% [D][169], shown on a Delft-made device, is what uniform 300 mm gates must reproduce. Neighbouring empty slots: no spin-module interconnect (300 mm photonics is the candidate, unproven at millikelvin) and no fabricated cryogenic decoder; a cryo-CMOS predecoder design claims 3,780× syndrome-bandwidth reduction below 0.56 mW [S][541].

## Verification (QCVV)

Yield numbers come from cryo-probers at 1.6–1.7 K (automated tune-up, turn-on/pinch-off and charge-sensing criteria [D][172], [586]): transistor statistics. Fidelities come from few devices in dilution refrigerators: gate-set tomography (12,263 sequences) for the unit cells [D][162], randomised benchmarking on Tunnel Falls [D][172], T1/T2 wafer maps for transmons [D][217].

Not captured: (1) 1.6 K probing cannot see valley splitting, exchange or coherence, so device yield says nothing about qubit yield; (2) selection: 4 of 20 imec devices characterised [D][162], 6 of > 10,000 arrays cooled in 2022 [D][585]; (3) criteria: 28–40% and 96% define "working" differently [D][586], [587]; (4) no simultaneous all-pairs 2Q on any 300 mm array [D][170]; (5) ageing: 3.7% junction drift in 146 days [D][217] is absent from fidelity claims.

Replication: imec's SiMOS numbers reproduce across four devices and two institutions [D][162]; Intel's are single-vendor. Flagged: Quantum Motion's "first full-stack silicon CMOS quantum computer" without published fidelities [C][173]; Equal1's commercial-process dots without qubit metrics [C][590].
...
|---|---|---|---|---|
| Intel | developer; captive supplier | US | Si/SiGe EUV arrays; cryo-prober wafer statistics; 12-qubit chip at Argonne | [D][172], [586]; [G][175] |
| imec | research; supplier | BE | 300 mm SiMOS dots, transmons, millikelvin multiplexer; SPINS coordinator | [D][162], [217], [597]; [G][592] |
| GlobalFoundries | supplier (merchant foundry) | US | 22FDX dots and cryo-CMOS; Quantum Technology Solutions unit; $375 M LOI | [C][284], [598]; [G][224] |
| IBM | developer; supplier | US | Anderon: 300 mm superconducting wafers, TSVs, bumps; $1 B LOI | [C][10], [593]; [G][224] |
| Diraq | developer | AU | SiMOS unit cells at imec; QBI Stage B; CHIPS LOI up to $38 M | [D][162], [170]; [G][60], [224] |
| Quantum Motion | developer | UK | 22FDX 1,024-dot arrays; NQCC system; QBI Stage B | [D][587]; [C][173]; [G][60] |

**Money.**

| date | actor | event | amount | lead or programme | cumulative | status |
|---|---|---|---|---|---|---|
| 2025-11-06 | Diraq; Quantum Motion; SQC | grant | up to $15 M each | DARPA QBI Stage B | — | definitive [G][60][G:QBI-STAGEB-2025-11] |
| 2026-01-15 | Equal1 | round | $60 M | ISIF | > $85 M | closed [C][591][G:EQUAL1-60M-2026-01] |
| 2026-04-03 | imec + 25 partners | grant | €50 M | EU Chips JU SPINS pilot line | — | announced [G][592] |
| 2026-05-07 | Quantum Motion | Series C | $160 M | DCVC, Kembara | — | closed [C][286][G:QM-160M-2026-05] |
| 2026-05-21 | GlobalFoundries | CHIPS LOI | $375 M | US Commerce ($2.013 B over nine LOIs) | — | LOI, non-binding [G][224][C][284][G:CHIPS-LOI-2026-05] |
| 2026-05-21 | IBM (Anderon) | CHIPS LOI | $1 B + $1 B IBM cash | US Commerce | — | LOI, non-binding [G][224][C][593] |
| 2026-05-21 | Diraq | CHIPS LOI | up to $38 M | US Commerce | > $100 M raised [P][G:DIRAQ-FUNDING] | LOI, not awarded [G][224] |
| 2026-06-03 | Quobly | Series A | €115 M | Bpifrance, SEALSQ, STMicroelectronics | €134 M | closed [P][599][G:QUOBLY-115M-2026-06] |
| 2026-06 | Silex Systems | Q-Si plant completed | A$5.1 M + A$4.35 M | Defence Trailblazer; SQC | — | commissioning late 2026 [C][594] |
...
| 2026-07-31 | IonQ | M&A: SkyWater | $15.00 + 0.4883 IonQ shares per share (~$1.8 B) | — | — | closed [C][18][G:IONQ-SKYWATER-2026] |

**Market & supply chain.** Quantum is immaterial to foundry revenue. Concentration: two EUV-capable dot lines, one merchant FD-SOI option (ST entering), a prober duopoly, one 28Si plant. Unit economics: unpublished beyond Diraq's target [R][178]. Payers: G4 for 10⁶-qubit CMOS density; G7, as of 3 Sep 2026, for rack-scale spin systems; superconducting vendors buy Anderon/GF wiring for G2–G4; ion vendors buy standard-fab traps for G2, G3, G7.

**IP & standards.** Portfolios: Intel, HRL, Diraq/UNSW, Quantum Motion/UCL, Quobly (CEA/CNRS licences), Equal1; no litigation public; no dated family count from a named database found. SPINS promises quantum PDKs and multi-project-wafer access [G][592]; GF markets FDX cryogenic models [C][284]; no open cryogenic device-model standard exists.

**Roadmaps & track record.** Intel (promised 2022 · wafer-scale qubits · delivered 2024, Argonne 2026-01-06 [G][175][G:INTEL-2026]; no successor or roadmap as of 2026-09-03). Diraq (promised 2026-07-09 · "thousands" by 2029, restated 2026-08-27 as 150,000 physical · eight qubits shown [D][170][R][178][G:DIRAQ-FUNDING]). Quantum Motion (promised 2025-01 · NQCC system · delivered 2025-09-15, no published fidelity [C][173], [598]). Quobly (promised 2025-12 · ST-lot metrics Q1 2026 [P][588] · none found as of 2026-09-03). GF, Anderon: no wafer dates promised [C][284], [593]. Credibility: imec/Diraq (peer-reviewed, replicated) first; Intel manufactures without a product path; Quantum Motion, Quobly, Equal1 deliver systems without metrics; roadmap slides last.
...
- SPAM for the imec/Diraq unit cells: 99.95% at 100 µs [162] (v1 value, retained) against 99.9% recorded for imec's 300 mm line (2025).
- Shuttling fidelity [169]: v1 gave 99.54%; the abstract states "99.5% on average"; the abstract value is used.
- Silex funding (A$5.1 M Defence Trailblazer, A$4.35 M SQC): amounts undated on the Silex page [594]; the ledger row is dated by the June 2026 plant completion.
- [589] Losert et al.: bibliographic details are cited from the standard literature and not confirmed against the publisher's page.
- Dropped from v1 as unverified here: the "~1% Commerce equity stake" in GF's CHIPS LOI (v1 cited [224], [284], [593] jointly), IBM's 30× device-output claim for Anderon (trade-press proxy only), and Intel's 91% single-electron-sensing figure [586] versus 96% tune-up [172] (different device sets and criteria).
