...
## Identity & lineage
Commodity telecom single-mode fibre carrying single photons or heralded entangled pairs between photonic chips, racks or modules. PsiQuantum published chip-to-chip Bell fidelity 99.72 ± 0.04% over 42 m in Omega [D][1]; Aurora networks 35 chips over fibre at ~14 dB total loss [D][2]. The same physics underwrites metropolitan entanglement distribution, where rates are published. Attributes: flying photons, no deterministic timing, loss-dominated error; room-temperature electro-optic interfaces, photonic-IC fibre coupling.

## Physics & limits
Attenuation is not the binding term at machine scale. Forty-two metres at 0.2 dB/km is ~8 mdB, while the two fibre-to-chip transitions bracketing it cost 52 ± 12 mdB each [D][1] — ~104 mdB, a fifth of a ~0.5 dB per-photon budget, spent on connectors rather than span. Modularity here is priced per interface, unlike matter-qubit links. What distance costs is time: 42 m is ~206 ns one way at group index 1.47, longer than the best 2026 feed-forward electronics, so separation eats the decision budget before the loss budget. Rate is the term no computing vendor publishes, and its exchange against loss is brutal: 0.7 coincidences/s through 66 dB of metropolitan fibre versus 132/s on the 93 km leg [P][3]. At rack-scale loss the ceiling reverts to source brightness and multiplexing depth.

## Engineering state of the art

| Date | Figure | Who | Tag |
|---|---|---|---|
| 2025-01 | 35 chips networked over fibre, ~14 dB total loss | Xanadu | [D][2] |
| 2025-02 | Chip-to-chip Bell fidelity 99.72 ± 0.04% over 42 m | PsiQuantum | [D][1] |
| 2025-02 | Fibre-to-chip coupling 52 ± 12 mdB | PsiQuantum | [D][1] |
| 2026-06-10 | Edge coupling 0.085 dB/facet, claimed a benchmark | Xanadu | [C][4] |

The 2026 benchmark claim does not survive comparison: PsiQuantum's 52 mdB is ~39% lower at the same interface a year earlier [D][1][C][4]. Fidelity is past 99.7%; the missing number is throughput.

## Manufacturing, materials & supply chain
No new fabrication: fibre, connectors and edge-coupled arrays are commodity telecom, with Corning fibre arrays and DISCO singulation behind Xanadu's coupling figure [C][4]. The scaling variable is attachment count: every module boundary is two attachments, each a yield event and a 52 mdB loss event, so at 10³ modules packaging throughput sets the build rate; at 10⁴ bundle volume and timing calibration bind; nothing addresses 10⁶. I/O burden sits upstream, in the source and the fusion measurement. The machine falls under BIS ECCN 4A906 [G:BIS-QUANTUM-2024].

## Role in the stack
Both photonic paths depend on it — fusion (PsiQuantum, Quandela, QuiX) and continuous-variable/GKP (Xanadu) — to scale past one chip's mode count, contributing ~0.21 µs per 42 m to the derived clock, comparable to the whole feed-forward term. Verification: the 99.72% is a conditional Bell fidelity on heralded events, channel loss excluded [D][1], so it says nothing about link efficiency, and it is single-source as of 2026-09-04.
...
|---|---|---|---|---|
| PsiQuantum | developer | US | Highest published chip-to-chip Bell fidelity over 42 m | [D][1] |
| Xanadu | developer | CA | 35-chip fibre-networked system; coupling benchmark | [D][2] |
| Quandela | developer | FR | Fielded 12-qubit Lucy coupled to Joliot-Curie HPC | [C][5] |
| Corning | supplier | US | Fibre arrays for photonic chip packaging | [C][4] |
...
**Roadmaps & track record.** PsiQuantum's 99.72% is unchanged since 2025-02, its 2026 progress visible only through DARPA V&V [D][1]. Xanadu marketed a coupling benchmark it does not hold [C][4]. No actor has published a dated inter-module rate target — a roadmap gap, not a slipped promise.
...
[3] J. Du *et al.*, “Entanglement distribution over 155 km metropolitan fiber using a CMOS-compatible silicon chip,” [arXiv:2409.17558](https://arxiv.org/abs/2409.17558), Sep. 2024. [P]
[4] Xanadu, “Xanadu sets new industry benchmark in photonic chip packaging,” PR Newswire, Jun. 10, 2026. [Online]. Available: https://www.prnewswire.com/news-releases/xanadu-sets-new-industry-benchmark-in-photonic-chip-packaging-302796562.html [C]
[5] M. U. Rehman, “Quandela Deploys Photonic Quantum Computer Integrated with HPC System,” The Quantum Insider, Apr. 14, 2026. [Online]. Available: https://thequantuminsider.com/2026/04/14/quandela-photonic-quantum-hpc/ [C]
