...
## Physics & limits
Γ_Z ≈ n̄/T1: the encoding turns cavity lifetime directly into logical quality, and photon number buys bit-flip suppression at a linear price. Ocelot closes the loop: at n̄ = 2 the storage lifetime is 57–68 µs [D][1]. Run that arithmetic at the operating point the estimates assume, n̄ ≈ 19 and 10⁻³ phase-flip per cycle, and the required cavity T1 is n̄·t/p ≈ 53 ms [S][1], [2]. The best published cavity memory is 25.6 ms, built by decoupling the mode from its ancilla — the opposite of what a stabilised cat does [D][3]. That is the floor: the qubit-count argument is a claim about cavity lifetime under strong drive. What moves it: lower single-photon loss at high pump power, or squeezed cats [D][4].
...
| 2025-09 | 12-cat chip: mean bit-flip 44 min, peak 252 min, preliminary | Alice & Bob | [C][5] |
| 2025-02 | Squeezed-cat variant: 22 s bit-flip | Alice & Bob | [D][4] |
...
|---|---|---|---|---|
| Alice & Bob | developer | FR | Bit-flip records, 18-cat Helium, a cat-only roadmap | [C][5] |
...
2026-05-22 · Alice & Bob · Series B extension · undisclosed · NVentures lead · closed [C][7]
...
**Roadmaps & track record.** The published ladder runs Helium (18 cats, 1 logical, 10⁻², delivered 2026-06) → Lithium (48/4, 10⁻³) → Beryllium (250/5, 10⁻⁴) → Graphene (2,000/100, 10⁻⁶, 2030) [R][6]. Chips arrive on time, but no logical error rate has been published for any, so every defining number is a promise. AWS has published no cat roadmap past Ocelot.
...
Confirm by 2027 if phase-flip per cycle falls below 10⁻² with bias above 100 at fixed n̄; demote the efficiency claims if it stays near 10⁻¹. Best case 2029: a cat at n̄ ≥ 5 with millisecond lifetime under active stabilisation. Worst case: bias saturates and the 758-cat and 126,133-cat estimates stay unreachable [S][2], [8]. Open: does squeezing survive multi-qubit operation; can pump power rise without loading T1? Watch Lithium and any Ocelot successor.

## Sources
[1] H. Putterman *et al.*, “Hardware-efficient quantum error correction via concatenated bosonic qubits,” *Nature*, vol. 638, no. 8052, pp. 927–934, Feb. 2025, doi: [10.1038/s41586-025-08642-7](https://doi.org/10.1038/s41586-025-08642-7).
...
[3] O. Milul *et al.*, “Superconducting Cavity Qubit with Tens of Milliseconds Single-Photon Coherence Time,” *PRX Quantum*, vol. 4, no. 3, Art. no. 030336, Sep. 2023, doi: [10.1103/PRXQuantum.4.030336](https://doi.org/10.1103/PRXQuantum.4.030336).
[4] N. Coppola, “Alice & Bob Improves Error Suppression in Quantum Computers by 'Squeezing' Cat Qubits,” Alice & Bob, Mar. 11, 2025. [Online]. Available: https://alice-bob.com/newsroom/squeezed-cat-qubit/ [C]
...
[8] D. Ruiz, J. Guillaud, A. Leverrier, M. Mirrahimi, and C. Vuillot, “LDPC-cat codes for low-overhead quantum computing in 2D,” *Nat. Commun.*, vol. 16, Art. no. 1040, 2025, doi: [10.1038/s41467-025-56298-8](https://doi.org/10.1038/s41467-025-56298-8). [arXiv:2401.09541](https://arxiv.org/abs/2401.09541).
[9] DARPA, “Stage B selection,” Nov. 6, 2025. [Online]. Available: https://www.darpa.mil/research/programs/quantum-benchmarking-initiative/stage-b-selection
...
Nord Quantique's QBI Stage B award [9] is cited for programme context; its GKP route does not use this encoding.
