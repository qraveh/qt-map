...
| 2026-08 | Paired λ/4 coaxial cavities: dual-rail CZ ≈500 ns, erasure 0.5%/gate, Pauli 0.029(6)% | Quantum Circuits | [D][4] |

Typical at scale is far below best: 18 cat modes (Helium), five storage modes (Ocelot) [C][5][D][6]. The dominant operating term is ancilla-induced dephasing plus gate-visible loss, the 0.5%-per-gate erasure being that loss detected [D][4].
...
## Role in the stack
Requires machined 3D cavities; provides the mode for cat and GKP encodings, dual-rail erasure, ancilla-mediated gates and dispersive readout. Derived clock = sum of the syndrome round: gate layers + transport + readout + reset: 2.8 µs on the dual-rail cavity path, four 500 ns CZ layers over a ~0.4 µs check [D][4], and 1.44 µs on the cat path, gate-set, against its measured 2.8 µs cycle [D][6]. Verification: the 25.6/34 ms figures are single-group and unreplicated [D][2]; the dual-rail CZ's Pauli error is post-selected, and its Λ ≈ 27 is simulated, not measured [S][G:QCI-LAMBDA27-2026-08].
...
|---|---|---|---|---|
| Alice & Bob | developer | FR | 18-cat-mode Helium system, ~40 kW, sold to GENCI | [C][5] |
| D-Wave | developer | US | λ/4 coaxial cavity dual-rail qubits, via Quantum Circuits | [D][4] |
| AWS | developer | US | Ocelot: five storage modes, four ancillas, five buffers | [D][6] |
| Nord Quantique | developer | CA | Multimode cavity GKP, T1 360 µs | [D][3] |
...
2026-05-18 · Nord Quantique · growth equity · $30 M at $1.4 B · — · closed [C][7]

**Market & supply chain.** Nobody sells cavities; the money is downstream in fridges and amplifiers. Unit economics are unpublished — Helium's ~40 kW for 18 modes is a whole-system figure [C][5]. G3 pays here, G4 does not at cm scale.
...
**Roadmaps & track record.** Alice & Bob delivered Helium 2026-06 as promised, without logical data [C][5]. D-Wave promises DR17 (2026), DR49 (2027), DR181 (2028), 10 logical (2030), 100 logical (2032) at Λ = 10 [R][G:DWAVE-DR-NAMING-2026-08]. Both ship on time and defer the numbers that matter.
...
No cavity quality factor has been published for the λ/4 coaxial bodies used in the 2026-08 dual-rail CZ [4].
SUSTech's dual-rail work uses four transmon qubits, so SUSTech is not an actor for this carrier.
Helium's "up to 200× lower hardware requirements" is a company claim with no logical-level data behind it [C][5].
