...
| 2024-05 | SiV: F = 0.69(7) between nuclear memories over a 35 km deployed Boston loop; 0.86(3) electron–electron at 20 m, ≤1 Hz | Harvard | [D][3] |
| 2024-06 | T centre, two modules in separate cryostats over ~40 m fibre: Bell F = 0.60(8), ~7.5 mHz; teleported-CNOT sequence post-selected, no gate fidelity | Photonic Inc. | [P][4] |
...
| Photonic Inc. | Developer | Canada | Silicon T-centre modules, native telecom emission | [P][4] |
| Harvard University | Research | USA | SiV nanophotonic nodes over a 35 km deployed loop | [D][3] |
