...
| Quantum Machines | supplier | Israel | Readout stack for nine spin teams | [C][4] |
...
**Market & supply chain.** Zurich Instruments and Quantum Machines supply the rf chain nearly every spin team buys rather than builds [C][3], [4]; cryogenic amplification is the second pinch point. Pays into G2, G3, G7.
