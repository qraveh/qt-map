...
|---|---|---|---|---|
| QuTech | research | Netherlands | SnV nanocavity fabrication, yield data | [D][294] |
| Element Six | supplier | UK | Merchant CVD diamond plates | [C][293] |
| Harvard | research | USA | Implanted SiV nanophotonics | [D][177] |
| Quantum Brilliance | developer | Australia | Room-temperature units | [P][296] |
| QuantumDiamonds | developer | Germany | NV microscopy, Munich | [P][296] |

**Money.** 2026-07 · QuantumDiamonds · grant and equity · EUR 91 M, EUR 76 M of it EU Chips Act · financing a EUR 152 M Munich facility · closed [P][296]. 2025-01 · Quantum Brilliance · Series A · USD 20 M · ~USD 58 M cumulative · closed [P][296]. No QBI stage names diamond manufacturing.
...
**Roadmaps & track record.** QuTech (modular-computing programme · on schedule) [D][294]. QuantumDiamonds (Munich facility, 2026-07 · too new to judge) [P][296]. Quantum Brilliance (units at three laboratories · delivered, dates unstated) [P][296]. No actor publishes a dated yield target.
...
- The 327-device SnV yield is published as an institutional news item [294]; the underlying peer-reviewed paper was not located, so the figure is single-source and unreplicated.
- Element Six's quantum-technologies product page returned 404 on 2026-09-04; no dated capacity, revenue or investment figure specific to its quantum segment was found, and its sole-supplier status rests on a secondary survey [296].
