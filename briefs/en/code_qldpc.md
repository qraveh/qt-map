...
The code sets no energy scale, only an accounting rate: k/n and syndrome depth. The gross code encodes one twelfth of its data qubits, and its depth-7 syndrome circuit costs seven two-qubit layers plus a measurement per round — the surface code's depth, on a graph the hardware does not have [D][227]. The floor is the threshold, 0.8% under circuit-level depolarising noise [D][227]; below it, suppression per distance step beats the surface code because the block carries more logical qubits per unit of syndrome information, not because any qubit is better.

Two structural penalties are real. Distance is not free: distance 12 in 288 qubits needs the long-range wraps, and deleting them collapses the family to something a heavy-hex lattice can host, rate advantage gone. Decoding is harder: the Tanner graph has short cycles, so minimum-weight matching does not apply and plain belief propagation does not converge; the practical choices are BP with ordered-statistics post-processing (accurate, too slow) or Relay-BP [S][46]. The worst failure mode is anything the code does not see as Pauli — leakage, ion or atom loss — a sparse code having fewer redundant checks to localise a hyper-edge. Erasure conversion and leakage removal move this floor further than better gates.

## Engineering state of the art

Best demonstrated as of 3 Sep 2026: 4 logical qubits in 18 trapped ions at break-even (IonQ, June 2026) [D][103]. Typical at scale: nothing — no BB code has run on more than 32 physical qubits, and none has hosted a logical two-qubit gate.

**Records timeline**

| Year | Figure | Who | Tag+key |
|---|---|---|---|
| 2024-03 | [[144,12,12]]: 288 physical for 12 logical, threshold 0.8%, ≈10× fewer qubits than surface code | IBM | [D][227] |
...
|---|---|---|---|---|
| IBM | developer | US | Invented the gross code; Loon connectivity chip, Kookaburra module, Relay-BP decoder | [D][227][S][46], [383] |
| IonQ (Oxford Ionics) | developer | US/UK | Only break-even qLDPC hardware result, 4 logical in 18 ions | [D][103] |
| Zhejiang University | research | CN | First BB code on hardware, 32-qubit Kunlun processor | [D][69] |
| Photonic Inc. | developer | CA | SHYPS qLDPC family, "up to 20x fewer physical qubits" | [C][509][P][510] |
| IQM | developer | FI | Resonator hubs; qLDPC demonstrators promised 2027-28 | [C][374] |
| DARPA | funder | US | QBI Stage B funds IBM, IonQ, Photonic Inc. and eight others | [G][60][G:QBI-STAGEB-2025-11] |

**Money.**
- 2025-11-06 · DARPA · QBI Stage B, eleven teams · up to $15 M each (USD) · announced [G][60][G:QBI-STAGEB-2025-11]
- 2026-05-12 · Photonic Inc. · final close · $200 M at $2 B (USD) · Microsoft among returning investors · $350 M total · closed [P][160][G:PHOTONIC-200M-2026-05]
- 2026-05-21 · IBM/Anderon · CHIPS letter of intent · $1 B + $1 B IBM cash (USD) · Dept of Commerce · LOI [G][224][G:CHIPS-LOI-2026-05]
- 2026-06-02 · IBM · five-year quantum commitment · >$10 B (USD) · announced [C][55][G:IBM-10B-2026-06]
- 2026-07-31 · IonQ · SkyWater, captive ion-trap fab · ~$1.8 B (USD) · closed [C][18][G:IONQ-SKYWATER-2026]

**Market & supply chain.** Nobody sells qLDPC. What sells is the connectivity that makes it usable — multi-layer superconducting interconnect (IBM at Albany, IQM's resonator hubs), ion-trap chips (IonQ owns SkyWater [C][18]) — and the decoding that makes it affordable (IBM in-house, NVIDIA's fabric [P][253]). Concentration risk is extreme: one organisation holds both the code and the only connectivity vehicle built for it. Unit economics are the case, ~24 physical per logical against ~1,000 for a distance-25 surface patch [D][1], [227]. Only G3 and G4 pay for it.

**IP & standards.** No bivariate-bicycle patent family appears in the Justia index under that phrase as of 2026-09-03 — IBM published rather than fenced [P][511]. Enforceable IP sits one layer down: IBM US 12,517,856 (granted 2026-01-06) and US 12,587,192 on resonator chains with tunable inductive couplers (granted 2026-03-24) [G][385][G:LRCOUPLER-PATENTS]. Decoder IP is filed by others: KAIST US 12,346,774 (2025-07-01), Princeton US 11,941,489 (2024-03-26), US 2026/0172053 on qLDPC decoders (2026-06-18) [G][511]. Stim, PyMatching and BP-OSD carry the field; no standard exists.

**Roadmaps & track record.** IBM: Kookaburra, qLDPC memory plus logical processing unit (promised 2025-06-10 · for 2026 · not delivered as of 2026-09-03); Cockatoo modules (2025-06-10 · 2027 · pending); Starling, 200 logical and 10^8 gates (2025-06-10 · 2029 · pending) [R][67], [368]. The 2022-05-10 roadmap had promised Kookaburra as a 1,386-qubit processor for 2025 [C][240][G:IBM-ROADMAP-2022]; IBM has shipped every published component of the stack except the code itself, so 2026 is optimistic and 2027 plausible. IQM: qLDPC demonstrators (2026-01-05 · 2027-28 · pending) [C][374]. Photonic Inc.: SHYPS announced 2025-02-11, peer-reviewed 2026-08, still no hardware [C][509][P][510].
...
Confirm within 12–24 months if IBM demonstrates a gross-code memory below break-even with real-time decoding (Kookaburra, promised 2026), if any group performs a logical two-qubit gate between BB blocks, or if a BB result appears without leakage post-selection. Demote if Kookaburra slips past end-2027, or if Loon's c-coupler fidelity when published is poor enough to eat the 10× rate advantage. Best case by 2029: Starling-class machines, 200 logical qubits at ≈24–40 physical each, factoring estimates falling to the 10⁵-qubit range [S][7], [28]. Worst case: a 20-qubit laboratory curiosity, connectivity costing more fidelity than the rate saves.
...
[28] P. Webster *et al.*, “The Pinnacle Architecture: Reducing the cost of breaking RSA-2048 to 100 000 physical qubits using quantum LDPC codes,” [arXiv:2602.11457](https://arxiv.org/abs/2602.11457), Feb. 2026. [S]
...
[69] K. Wang *et al.*, “Demonstration of low-overhead quantum error correction codes,” *Nat. Phys.*, 2026, doi: [10.1038/s41567-025-03157-4](https://doi.org/10.1038/s41567-025-03157-4). [arXiv:2505.09684](https://arxiv.org/abs/2505.09684). [D]
...
[253] S. Caldwell *et al.*, “NVIDIA NVQLink Architecture Integrates Accelerated Computing with Quantum Processors,” NVIDIA Technical Blog, Nov. 17, 2025. [Online]. Available: https://developer.nvidia.com/blog/nvidia-nvqlink-architecture-integrates-accelerated-computing-with-quantum-processors/ [P]
...
[509] Photonic Inc., “Photonic accelerates the timeline to useful quantum computing with breakthrough results in error correction,” Feb. 11, 2025. [Online]. Available: https://photonic.com/news/shyps-codes-announcement/ [C]
[510] M. U. Rehman, “Photonic Publishes SHYPS QLDPC Code Results in Nature Communications,” The Quantum Insider, Aug. 26, 2026. [Online]. Available: https://thequantuminsider.com/2026/08/26/photonic-shyps-quantum-error-correction-nature-communications/ [P]
[511] Justia Patents, “Patent search: ‘parity check’ quantum error correction code (results as of Sep. 3, 2026).” [Online]. Available: https://patents.justia.com/search?q=%22parity+check%22+quantum+error+correction+code Also https://patents.google.com/patent/US12346774B2/en. [P]
