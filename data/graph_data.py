...
N("ct_sfq",5,"SFQ digital control (millikelvin)","Цифровое SFQ-управление (милликельвины)",1.0,["fab"],None,"na",None,"none","mw","mK",["pauli"],"sclitho","E",
  "Single-flux-quantum pulse trains drive qubits from a flip-chip at mK; 1Q > 99% (99.9% peak); nW/qubit claimed.","Цепочки одноквантовых импульсов управляют кубитами с flip-chip при мК; 1Q > 99% (пик 99.9%); заявлено нВт/кубит.",
...
("dec_cryo","ct_sfq","cold digital logic","холодная цифровая логика"),("dec_cryo","ct_cryocmos","cold digital logic","холодная цифровая логика"),("dec_fpga","code_surface","matching/clustering on surface syndromes","matching/кластеризация на синдромах surface"),("dec_nn","code_surface","trained on surface-code syndromes","обучен на синдромах surface code"),
