...
N("ct_cryocmos",5,"Cryo-CMOS controller (4 K / mK)","Cryo-CMOS контроллер (4 K / мК)",1.0,["fab"],None,"na",None,"none","mw",["4K","mK"],["coherent"],"cmos","D",
...
N("ct_ionlaser",5,"Laser control with integrated photonics (ions)","Лазерное управление с интегрированной фотоникой (ионы)",0.0,["nat"],None,"na",None,"none","opt",["RT"],["coherent"],"pic","D",
  "In-vacuum integrated photonics at room temperature (cryogenic traps at 4–10 K exist): Waveguides in the trap deliver all wavelengths; > 99.3% 2Q (ETH); ≥ 7 wavelengths on Helios.","Интегрированная в вакууме фотоника при комнатной температуре (существуют криогенные ловушки при 4–10 K): Волноводы в ловушке доставляют все длины волн; > 99.3% 2Q (ETH); ≥ 7 длин волн на Helios.",
