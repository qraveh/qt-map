...
{MAPLEAD}
<div class="pcwrap" id="pcwrap"><h3 id="pcwrap-h"><span class="lang-en">Technologies across the seven attributes — a parallel-coordinates view</span><span class="lang-ru">Технологии по семи атрибутам — вид в параллельных координатах</span><button type="button" class="foldbtn" data-sec="pcwrap" aria-expanded="true" title="collapse / expand"></button></h3>
